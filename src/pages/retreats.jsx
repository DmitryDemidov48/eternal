            ...
            <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
                {[photo_2, photo_3, photo_4, photo_5, photo_6, photo_11].map((image, imageIndex) => (
                    <div
                        key={image.src}
                        className={clsx(
                            'relative aspect-[8/10] w-16 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 sm:w-52 sm:rounded-2xl ',
           ...
           <Photos/>
            <Container>
                    <BlogPost
                        ...
                        title="Мы с радостью делимся впечатлениями о недавно завершившемся ретрите в прекрасном городе Решикеш."
                        date=""
